 ...
 * Generated for Laravel 7.10.3 on 2020-05-16 04:00:43.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
                        /** @var \Rethings\Console\Kernel $instance */
    ...
    class Request {
        ...
        {
                        return \Illuminate\Http\Request::hasApp();
        }
        ...
        {
                        return \Illuminate\Http\Request::getAppId();
        }
        ...
        {
                        return \Illuminate\Http\Request::app();
        }
    ...
    class Route {
         ...
         * @static 
         */ 
        public static function rethingsApiResource($name, $controller, $options = [])
        {
                        return \Illuminate\Routing\Router::rethingsApiResource($name, $controller, $options);
        }
...
namespace Illuminate\Support { 
    ...
    class Arr {
        ...
        {
                        return \Illuminate\Support\Arr::undot($array);
        }
        ...
        {
                        return \Illuminate\Support\Arr::camelCaseKeys($array);
        }
